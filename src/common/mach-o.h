...
#define MH_NOUNDEFS \
    0x00000001 /* the object file has no undefined references, can be executed */
#define MH_INCRLINK \
    0x00000002 /* the object file is the output of an incremental link against a base file and can't be link edited again */
#define MH_DYLDLINK \
...
#define MH_PREBOUND \
    0x00000010 /* the file has it's dynamic undefined references prebound. */
...
enum {
    ...
    CSSLOT_ALTERNATE_CODEDIRECTORY_LIMIT = CSSLOT_ALTERNATE_CODEDIRECTORIES +
